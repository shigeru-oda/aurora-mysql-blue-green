...
resource "aws_rds_cluster_parameter_group" "aurora_mysql_param_group_57" {
  ...
  dynamic "parameter" {
    for_each = local.aurora_mysql_param_group
    content {
...
resource "aws_rds_cluster_parameter_group" "aurora_mysql_param_group_80" {
  name   = "aurora-mysql-cluster-param-group-80"
...
resource "aws_db_parameter_group" "aurora_mysql_db_param_group_80" {
  name   = "aurora-mysql-db-param-group-80"
  family = "aurora-mysql8.0"
